<div class="col-xs-12">
    <div class="breadcrumb">
        ...
        <div class="breadcrumb-item">Tipo de Proveedor</div>
    </div>
    <form action="<?= site_url('api/proveedores_tipo') ?>" method="post" target="_blank" id="proveedores_tipo_proveedor"
          name=proveedores_tipo_proveedor"">
